document.addEventListener('DOMContentLoaded', () => {
    ...
    const authSignupBtn = document.getElementById('auth-signup-trigger'); // New auth page trigger

    if (signupBtn && kycOverlay) {
        ...
        nextBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                if (currentStep < 3) {
                    ...
                    if (currentStep === 3 && otpFields.length > 0) {
